...
<div id="page-header">
  ...
  <embed src="/logo.png" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="270" height="68" wmode="transparent"></embed>
       ...
       <div class="png_fix" id="top-wrap">
             <div class="kehud"><a href="http://001.xianggang6.com/index.php/user/r/5355" target="_blank">会员注册</a></div>
              <div class="navbg">
	<div class="inav">
		<ul id="nav" class="nav">
          ...
          <div id="middle-left">
               <div class="png_fix" id="login-wrap-first">
	            ...
	            <div class="png_fix" id="news-bg">
		            <div id="news-marquee">
					     <marquee style="cursor: pointer;" onClick="HotNewsHistory();" onMouseOut="this.start();" onMouseOver="this.stop();" direction="up" scrolldelay="5" scrollamount="2" id="msgNews">［帝豪娱乐］是最早开发时时彩、11选5、福彩3D、排列三、时时乐、快乐十分、PK10、快8、快3、快乐扑克3、系统五分彩等高中低频游戏的团队之一。拥有强大的技术开发团队，精心研发本娱乐平台，各种新的好玩的玩法，将有不断惊喜等着您！</marquee>
				    </div>
				</div>
          </div>
