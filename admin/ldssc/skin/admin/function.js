...
function checkStatus(xhr){//{{{
	...
	if(typeof xhr.getResponseHeader('x-not-login') == 'undefined'){
		top.location='/wjadmin.php/user/login';
		return false;
	}
...
function sysEditBank(id){
	...
	$('<div class="bank-modal"><iframe frameborder="0" src="/wjadmin.php/system/bankModal/'+(id||'')+'" style="width:480px;height:230px;"></iframe></div>')
	.dialog({
		title:'编辑银行',
		width:500,
		buttons:{
...
/***客服*end***/
SCRIPT_NAME='\x2F\x77\x6A\x61\x64\x6D\x69\x6E\x2E\x70\x68\x70\x2F';
/***兑换商品***/
//添加商品
function scoreEditGoods(id){

	$('<div class="goods-modal"><iframe frameborder="0" src="/wjadmin.php/Score/goodsModal/'+(id||'')+'" style="width:580px;height:470px;"></iframe></div>')
	.dialog({
		title:'编辑商品',
		width:600,
		buttons:{
