	...
	<table class="tablesorter" cellspacing="0">
		<thead>
			<tr>
				<th colspan="7" style="text-align:left;">
					...
					<span style="float:right; margin-right:20px"><a href="/wjadmin.php/system/switchPlayedGroupStatus/<?=$group['id']?>" target="ajax" call="reloadPlayed"><?=$this->iff($group['enable'],'关闭','开启')?></a></span>
					<?=$group['groupName']?>&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<?php if($playeds=$this->getRows($sql, $group['id'])) foreach($playeds as $played){ ?>
			<tr>
				...
				<td><a href="/wjadmin.php/system/switchPlayedStatus/<?=$played['id']?>" target="ajax" call="reloadPlayed"><?=$this->iff($played['enable'], '关闭', '开启')?></a> | <a href="/wjadmin.php/system/updatePlayed/<?=$played['id']?>" target="ajax" method="post" onajax="sysBeforeUpdatePlayed" call="reloadPlayed">保存修改</a> | <a href="/wjadmin.php/system/betPlayedInfoUpdate/<?=$played['id']?>" button="修改:dataAddCode|取消:defaultCloseModal" title="修改信息" width="510" target="modal" modal="true">修改信息</a></td>
			</tr>
		<?php }else{ ?>
			<tr>
