...
<article class="module width_full">
    <header>
    	<h3 class="tabs_involved">登录日志
            <form action="/wjadmin.php/manage/loginLog" target="ajax" dataType="html" call="defaultSearch" class="submit_link wz">
	...
	<?php if($data['data']){
		...
		<tr>
			...
			<!--<td><?//=iconv('gbk','utf-8',convertip(long2ip($var['loginIP'])))?></td>-->
			<td><?=$var['browser']?></td>
			<td><?=$var['os']?></td>
