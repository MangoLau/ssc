...
<article class="module width_full">
	<header>
		...
		<form action="/wjadmin.php/business/coinLog" class="submit_link wz" target="ajax" call="defaultSearch" dataType="html">
	...
	?>
		<tr>
            ...
            <?php if($var['extfield0'] && in_array($var['liqType'], array(2,3,4,5,6,7,10,11,100,101,102,103,104,105,108))){ ?>
                <td><a target="modal" button="关闭:defaultCloseModal" width="510" title="投注信息" href="/wjadmin.php/business/betInfo/<?=$var['extfield0']?>"><?=$this->ifs($var['extfield0'], '--')?></a>
                </td>
			...
			<?php }elseif(in_array($var['liqType'], array(1,9,52))){?>
                <td><a href="/wjadmin.php/business/rechargeInfo/<?=$var['extfield0']?>" width="500" title="充值信息" button="关闭:defaultCloseModal" target="modal"><?=$var['extfield1']?></a></td>
                <td>--</td>
                <td>--</td>
                <td>--</td>
                <td>--</td>
			<?php }elseif(in_array($var['liqType'], array(8,106,107))){?>
                <td><a href="/wjadmin.php/business/cashInfo/<?=$var['extfield0']?>" width="500" title="提现信息" button="关闭:defaultCloseModal" target="modal"><?=$var['extfield0']?></a></td>
                <td>--</td>
                <td>--</td>
                <td>--</td>
                <td>--</td>
