...
<article class="module width_full">
	...
	?>
		<tr> 
			...
			<td><a href="/wjadmin.php/Score/goodsOnoff/<?=$var['id'].'/'.$var['enable']?>" target="ajax" call="goodsHandle" dataType="json"><?=$statebtn?></a> | <a href="#" onclick="scoreEditGoods(<?=$var['id']?>)">修改</a> | 
            <?php 
			if($var['id']!=6){
			?>
            <a href="/wjadmin.php/Score/goodsDel/<?=$var['id']?>" target="ajax" call="goodsHandle" dataType="json">删</a>
           <?php  } ?>
            </td>
		</tr> 
	<?php }else{ ?>
