...
<body>
<form name="score_addGoods" action="/wjadmin.php/Score/updateGoods" enctype="multipart/form-data" method="POST">
<?php
	if($args[0]){
...
?>
    ...
    <tbody>
        ...
        <tr> 
            <td>缩略图</td> 
            <td><input type="" name="picmin"/><img src="/<?=$goods['picmin']?>" width="80" height="50" border="0"/></td>
        </tr>
        <tr> 
            <td>大图</td> 
            <td><input type="" name="picmax"/><img src="/<?=$goods['picmax']?>" width="120" height="50" border="0"/</td>
        </tr>
        <tr> 
            <td>状态</td> 
            <td>
