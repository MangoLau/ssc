...
<table class="tablesorter" cellspacing="0">
	...
	?>
		<tr>
			...
			<td>
                <?php if(!$noChildren){?>
                <a target="ajax" dataType="html" call="defaultList" href="<?="/wjadmin.php/countData/betDateSearch/?parentId={$var['uid']}&fromTime={$para['fromTime']}&toTime={$para['toTime']}"?>">下级</a>
				<?php }?>
                <?php if($var['parentId']){?>
                  <a target="ajax" dataType="html" call="defaultList" href="<?="/wjadmin.php/countData/betDateSearch/?uid={$var['uid']} &fromTime={$para['fromTime']}&toTime={$para['toTime']}"?>">上级</a>
				<?php }?>
            </td>
		</tr>
	<?php } ?>
