...
<div class="content3 wjcont">
 ...
 <div class="mima1">
    ...
    <ul>
     ...
     <li><span>用户名：</span><input type="text" name="username" class="text4" /></li>
     ...
     <!--li><span>人数配额：</span><input type="text" name="subCount" class="text4" /></li-->
	 <li><span>返点：</span><input type="text" name="fanDian" class="text4" max="<?=$this->user['fanDian']?>" fanDianDiff=<?=$this->settings['fanDianDiff']?> />%</li>
     <li><span>不定位返点：</span><input type="text" name="fanDianBdw" class="text4" value="0" max="<?=$this->user['fanDianBdw']?>" />%</li>
