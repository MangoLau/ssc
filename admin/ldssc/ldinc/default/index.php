		...
		<ul id="nav" class="nav">
			...
			<li class="nLi nlibg2"><a href="#">时时彩</a>
					<ul class="sub" style="display: none;">
						...
						<li><a href="/index.php/index/game/31/2"><img src="/skin/images/n31.png" alt="" />香港二分彩</a></li>
					</ul>
            </li>
			...
			<li class="nLi nlibg5"><a href="#">会员中心</a>
					...
					<ul class="sub" style="display: none;">
            			...
            			<li class="nLi nlibg7"><a href="/index.php/notice/huodong">优惠活动</a></li>
		</ul>
    </div>
</div>
       </div>
     	  ...
     	  <div class="clearfix" id="middle-game">
		       <div id="firstGame-wrap">
	           	...
	           	<div class="png_fix" id="firstBTN-wrap">
	                ...
	                <div class="hover_fade firstBTN-div" id="firstBTN-new"><a target="_blank" href="http://www.lidu118.com/"></a></div>
	                <div class="hover_fade firstBTN-div" id="firstBTN-service" onclick="wjkf168();"><a href="http://w30.pop800.com/web800/c.do?n=130924&l=cn&type=1&at=0"></a></div>
	           </div>
	      </div>
     </div>
</div>          </div>
