...
<div class="zhuce2">
 ...
 <div class="zhucel">
  <p>　　客户端下载 - 为了保障用户利益，本平台特些声明如下：<br />请广大用户认准本娱乐平台唯一地址:www.lidu188.com以免造成不必要的损失。</p>
...
<form action="/index.php/user/logined" method="post" onajax="userBeforeLogin" enter="true" call="userLogin" target="ajax">
  ...
  <br>
  <a title="忘记密码" id="login-pwd" target="_blank" href="http://api.pop800.com/chat/101759">忘记密码?</a>
  <br>
  <b><a href="#" onclick="$(this).closest('form').submit()">登 陆</a></b>
  </form>
<div class="service-tel"  style="margin-top:150px; margin-left:-120px;">温馨提醒：本站最佳显示分辨率为(1440×900)请使用IE8.0浏览器或360浏览器切换成IE兼容模式<br>Copyright 2012-2014 <a href="#">丽都娱乐</a> All Rights Reserved<br />
</div>
 </div>
</div>
...
<SCRIPT>alert('友情提示：\n\n严禁任何个人或团队用演示平台从事国家明令\n\n禁止的各种非法行为， \n\n前台后台测试账号：test2015  测试密码：a123456   \n\n工作室序出售唯一授权销售客服QQ:233****197 近期\n\n有些人拿演示平台去骗人，大家小心，谨防上当。\n\n工作室 唯一授权程序开发QQ：233****197   ');</SCRIPT>
</body>
</html>