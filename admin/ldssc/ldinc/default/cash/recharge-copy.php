...
<div class="content3 wjcont">
 ...
 <div class="body">
  <form action="/yeb/pay.php" method="POST" name="a32" target="_blank" >
     <div class="chongzhi3">
    ...
    <ul>
     ...
     <li><span>充值金额：</span><?=$args[0]['amount']?></li>
    </ul>
      <h3><input id="setcz" class="an" type="button" onclick="$(this).closest('form').submit()" value="进入支付" ><input type="reset" id="resetcz" class="an" value="重置" /></h3>
 </div>                     
