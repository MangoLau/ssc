...
?>
<div>
<form action="/wjadmin.php/business/betinfoUpdateed" target="ajax" method="post" call="betinfoDataSubmitCode" onajax="betinfoDataBeforeSubmitCode" dataType="html">
...
<div class="bet-info popupModal">
	<table cellpadding="0" cellspacing="0" width="480">
		...
		<tr>
			...
			<td>
<?php
		$sql="select * from {$this->prename}played where type={$bet['type']} and enable=1 ";

		$plays=$this->getRows($sql);
		if($plays){
?>
...
<?php } ?>
		...
		<tr>
			...
			<td>&nbsp;<?php //$this->iff($bet['qzEnable'], '是', '否')?></td>
        </tr>
		<tr>
