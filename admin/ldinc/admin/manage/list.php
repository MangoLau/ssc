	...
	<table class="tablesorter" cellspacing="0">
		...
		?>
			<tr>
				...
				?>
				<td><a href="/wjadmin.php/manage/pwdManagerModal/<?=$var['uid']?>" target="ajax" call="manageChangePwdModal">修改密码</a></td>
                 <?php
				}else{
				?>
                <td><a href="/wjadmin.php/manage/pwdManagerModal/<?=$var['uid']?>" target="ajax" call="manageChangePwdModal">修改密码</a> | <a href="/wjadmin.php/manage/deleteManager/<?=$var['uid']?>" target="ajax" call="manageDeleteManager" dataType="json">删除</a></td>
                 <?php
				}
				?>
			</tr>
		<?php 
				...
				<td>已被删除</td>
				<td><?=$this->iff($login['loginTime'],date('Y-m-d H:i:s', $login['loginTime']),'--')?></td>
                <td><a href="/wjadmin.php/manage/backNormalManager/<?=$var['uid']?>" target="ajax" call="manageBackNormalManager" dataType="json">还原</a> | <a href="/wjadmin.php/manage/clearManager/<?=$var['uid']?>" target="ajax" onajax="beforeClearManager" call="manageClearManager" dataType="json">清除</a></td>
