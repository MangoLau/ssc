<?php
	...
	$sql2="select * from {$this->prename}member_session where uid=? order by id desc limit 1";
...
?>
    ...
    <tr> 
        ...
        <td><?=$var['score']?><span class='spn10'>|</span><?=$var['scoreTotal']?><span class='spn10'>|</span><?=$var['grade']?></td> 
        ...
        <td><?=$this->iff($login['loginTime'],date('Y-m-d H:i:s', $login['loginTime']),'--')?><?//=$var['updateTime']?></td> 
        <td><a href="/wjadmin.php/Member/userAmount/<?=$var['uid']?>" target="modal"  width="420" title="用户统计" modal="true">统计</a> | <a href="business/coinLog?username=<?=$var['username']?>">帐变</a> | <a href="/wjadmin.php/Member/userUpdate/<?=$var['uid']?>" target="modal"  width="488" title="编辑用户" modal="true" button="确定:dataAddCode|取消:defaultCloseModal">编辑</a> | <a href="Member/index?type=2&uid=<?=$var['uid']?>" call="">下级</a> | <a href="/wjadmin.php/Member/delete/<?=$var['uid']?>" target="modal"  width="320" title="删除用户" modal="true" button="确定:dataAddCode">删</a></td> 
    </tr>
   <?php }else{?>
    <tr> 
        ...
        <td class="spn9"><a href="/wjadmin.php/Member/userAmount/<?=$var['uid']?>" target="modal"  width="420" title="用户统计" modal="true">统计</a> | <a href="business/coinLog?username=<?=$var['username']?>">帐变</a> | <a href="Member/index?type=2&uid=<?=$var['uid']?>" call="">下级</a></td> 
    </tr>
	<?php }} ?>
</tbody> 
</table>
