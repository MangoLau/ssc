	...
	<table class="tablesorter" cellspacing="0" width="100%">
		...
		<?php if($data['data']) foreach($data['data'] as $var){ ?>
			<tr>
				...
				<td><a href="/wjadmin.php/system/switchBankStatus/<?=$var['id']?>" target="ajax" call="sysReloadBank"><?=$this->iff($var['enable'], '关闭', '开启')?></a> | <a href="#" onclick="sysEditBank(<?=$var['id']?>)">修改</a> | <a href="/wjadmin.php/system/deleteBank/<?=$var['id']?>" target="ajax" call="sysReloadBank">删除</a></td>
			</tr>
		<?php }else{ ?>
			<tr>
