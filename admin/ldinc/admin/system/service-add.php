...
<footer>
    <div class="submit_link">
        <a onclick="this.href='/wjadmin.php/System/serviceAddNew/'+$(':input[name=\'serviceName\']').val()"  href="#" target="ajax" call= "serviceAddNew" dataType="html"><input type="submit" value="添加" class="alt_btn"/></a>
    </div>
</footer>
</form>
