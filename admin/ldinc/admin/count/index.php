<article class="module width_full">
	...
	<article style="margin:10px; width:20%; float:left;">
        <table align="center" style="text-align:center">
            ...
            <tr>
            	<td height="24"><?=$monthArr[$i]?></td><td><?=intval($betAmountArr[$i])?></td><td><?=intval($winAmountArr[$i])?></td>
            </tr>
			<?php }?>
            </tbody>
        </table>
	...
	<article class="stats_overview" style="margin:10px;">
		<?php $data=$this->getDateCount($date);
		  $jtTCount=number_format($data['betAmount']-$data['zjAmount']-$data['fanDianAmount']-$data['brokerageAmount'],0);
		  $jtYKCount=number_format($data['betAmount'],0);
		  if($jtTCount>0){
		...
		<?php 
		  ...
		  $ztTCount=number_format($data['betAmount']-$data['zjAmount']-$data['fanDianAmount']-$data['brokerageAmount'],0);
		  $ztYKCount=number_format($data['betAmount'],0);
		  if($ztTCount>0){
